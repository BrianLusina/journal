...
const AuthorCardTile: FunctionComponent<AuthorCardTileProps> = ({
  name,
  imageUrl,
  role,
  bio,
    ...
    <>
      <div className="flex items-start gap-6 mb-6">
        ...
        <div className="flex-1">
          ...
          <p className="text-sm text-muted-foreground">{articles} articles published</p>
        </div>
      </div>
      ...
      <div className="flex items-center gap-3">
        ...
        {facebook && (
          <a
            ...
            aria-label="Facebook"
          >
            <img src="https://simpleicons.org/?q=facebook" />
          </a>
        )}
        {linkedIn && (
          <a
            ...
            aria-label="LinkedIn"
          >
            <img src="https://simpleicons.org/?q=linkedin" />
          </a>
        )}
        {twitter && (
          <a
