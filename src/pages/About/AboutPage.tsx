    ...
    <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <div className="mb-16 text-center space-y-6">
        ...
        <p className="text-lg text-muted-foreground leading-relaxed animate-slide-up stagger-1">
          A space for exploring ideas, finding inspiration, and discovering new ways of seeing the
          world.
        </p>
      </div>
      ...
      <section className="mb-16 rounded-2xl bg-card p-8 md:p-12">
        ...
        <div className="space-y-4 text-muted-foreground">
          <p>
            We believe that how we see the world shapes how we experience it. Journal is dedicated
            to offering fresh viewpoints, practical insights, and inspiring stories that help
            readers:
          </p>
        ...
        <div className="grid md:grid-cols-2 gap-6">
          <div className="p-6 rounded-xl bg-muted">
            ...
            <p className="text-muted-foreground">
              We share real experiences, honest reflections, and genuine insights—not curated
              perfection.
            </p>
          </div>
          <div className="p-6 rounded-xl bg-muted">
            ...
            <p className="text-muted-foreground">
              Every article is carefully researched, thoughtfully written, and designed to add real
              value.
            </p>
          </div>
          <div className="p-6 rounded-xl bg-muted">
            ...
            <p className="text-muted-foreground">
              We welcome diverse perspectives and believe everyone's journey deserves respect and
              representation.
            </p>
          </div>
          <div className="p-6 rounded-xl bg-muted">
            ...
            <p className="text-muted-foreground">
              We promote practices that are sustainable for individuals, communities, and the
              planet.
            </p>
          </div>
        </div>
