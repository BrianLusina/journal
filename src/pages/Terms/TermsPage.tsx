// TODO: This is a placeholder page. We need to write the actual terms of service content here.
        ...
        <div className="prose prose-lg max-w-none space-y-8">
          <section>
            ...
            <p className="text-muted-foreground">
              By accessing or using Journal's website and services, you agree to be bound by these Terms of Service. 
          ...
          <section>
            ...
            <p className="text-muted-foreground mb-4">
              Permission is granted to temporarily access the materials on Journal's website for personal, 
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2 text-muted-foreground">
              ...
              <li>To impersonate or attempt to impersonate Journal or any employee</li>
          ...
          <section>
            ...
            <p className="text-muted-foreground">
              All content on Journal, including articles, images, logos, and designs, is the property of 
              Journal or its content creators and is protected by international copyright laws. 
          ...
          <section>
            ...
            <p className="text-muted-foreground">
              The materials on Journal's website are provided on an "as is" basis. Journal makes no 
          ...
          <section>
            ...
            <p className="text-muted-foreground">
              In no event shall Journal or its suppliers be liable for any damages (including, without 
              limitation, damages for loss of data or profit, or due to business interruption) arising out of 
              the use or inability to use the materials on Journal's website.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-muted-foreground">
              Our website may contain links to third-party websites that are not owned or controlled by Journal. 
          ...
          <section>
            ...
            <p className="text-muted-foreground">
              Journal may revise these Terms of Service at any time without notice. By using this website, 
