// TODO: add dynamic fetching of privacy policy content from backend API, implement versioning for different policy updates, and integrate with user account settings for personalized privacy controls
const PrivacyPage = () => {
  return (
      ...
      <div className="prose prose-lg max-w-none space-y-8">
        <section>
          ...
          <p className="text-muted-foreground">
            At Journal, we take your privacy seriously. This Privacy Policy explains how we collect,
            use, disclose, and safeguard your information when you visit our website and subscribe
            to our newsletter.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="text-muted-foreground">
            ...
            privacy practices of these third-party sites. We encourage you to read their privacy
            policies.
          </p>
        </section>
